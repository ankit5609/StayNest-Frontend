      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-[9998] bg-ink/40 backdrop-blur-sm"
            aria-hidden
          />
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-[9999] w-[calc(100vw-2rem)] max-w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-border/60 bg-white p-8 shadow-[0_32px_80px_-16px_rgba(17,26,19,0.22)]"
          >
            {/* Close button */}
            <button
              onClick={() => setOpen(false)}
              aria-label="Close"
              className="absolute right-5 top-5 rounded-full p-1.5 text-muted-foreground transition-colors hover:bg-surface hover:text-ink"
            >
              <X className="h-4 w-4" />
            </button>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h2
                id="auth-gate-title"
                className="mt-2 font-display text-2xl leading-snug text-primary"
              >
                Sign in to continue
              </h2>
