...
export function SearchHotelCard({ hotel, context }: Props) {
    ...
    >
        ...
        <button
          ...
          onClick={() =>
            toggle.mutate(
              ...
              {
                onError: (e) =>
                  toast.error((e as Error)?.message ?? "Couldn't update wishlist."),
              },
            )
          }
      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="flex items-start justify-between gap-3">
          <h3 className="min-w-0 truncate text-[16px] font-medium text-ink">
            {hotel.name}
          </h3>
          {hotel.reviewCount > 0 && (
