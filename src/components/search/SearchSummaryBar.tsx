...
import { GuestsField, type GuestsValue } from "@/components/landing/search/GuestsField";
...
export function SearchSummaryBar({
  ...
  const [checkIn, setCheckIn] = useState<Date | undefined>(fromIso(startDate));
  const [checkOut, setCheckOut] = useState<Date | undefined>(fromIso(endDate));
