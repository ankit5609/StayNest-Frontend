...
function wrap(children: React.ReactNode, props: LucideProps) {
...
export function PanelToggle(props: LucideProps) {
  return wrap(
    <>
...
export function SignOutIcon(props: LucideProps) {
  return wrap(
    <>
...
export function HotelIcon(props: LucideProps) {
  return wrap(
    <>
      {/* building body */}
...
export function BookingsIcon(props: LucideProps) {
  return wrap(
    <>
...
export function RefundIcon(props: LucideProps) {
  return wrap(
    <>
...
export function ConsoleIcon(props: LucideProps) {
  return wrap(
    <>
