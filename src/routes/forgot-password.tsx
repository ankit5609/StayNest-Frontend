...
export const Route = createFileRoute("/forgot-password")({
  head: () => ({
    meta: [
      { title: "Reset your password — StayNest" },
      {
        name: "description",
        content:
          "Enter your email and we'll send you a secure link to reset your StayNest password.",
      },
      { property: "og:title", content: "Reset your password — StayNest" },
      {
        property: "og:description",
        content: "Recover access to your StayNest account in a couple of clicks.",
      },
    ],
  }),
  ...
  return (
    <main className="min-h-screen bg-background px-3 py-3 md:flex md:items-center md:justify-center md:px-6 md:py-6">
      <motion.div
        ...
        className="mx-auto grid w-full max-w-[1180px] overflow-hidden rounded-[28px] bg-background shadow-[0_30px_100px_-40px_rgba(17,26,19,0.35)] ring-1 ring-black/[0.04] md:h-[min(700px,calc(100vh-3rem))] md:grid-cols-[54%_46%]"
      >
