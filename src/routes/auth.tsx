  ...
  head: () => ({
    meta: [
      { title: "Login — StayNest" },
      {
        name: "description",
        content:
          "Sign in to StayNest to continue your journey and discover handpicked stays that feel like home.",
      },
      { property: "og:title", content: "Login — StayNest" },
      {
        property: "og:description",
        content: "Sign in to StayNest to unlock member rates and curated stays.",
      },
    ],
  }),
  component: AuthPage,
  ...
  return (
    <main className="min-h-screen bg-background px-3 py-3 md:flex md:items-center md:justify-center md:px-6 md:py-6">
      <motion.div
        ...
        className="mx-auto grid w-full max-w-[1180px] overflow-hidden rounded-[28px] bg-background shadow-[0_30px_100px_-40px_rgba(17,26,19,0.35)] ring-1 ring-black/[0.04] md:h-[min(760px,calc(100vh-3rem))] md:grid-cols-[54%_46%]"
      >
        {/* LEFT — hero panel */}
        <section className="relative isolate overflow-hidden bg-surface min-h-[300px] md:min-h-full">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(17,26,19,0.35) 0%, rgba(17,26,19,0.1) 40%, rgba(17,26,19,0.55) 100%)",
            }}
          />
