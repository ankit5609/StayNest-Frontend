...
function BookingsPage() {
  ...
  const rows = useMemo(() => {
    ...
    return list
      ...
      .filter((b) =>
        q ? String(b.id).includes(q) || (b.room?.type ?? "").toLowerCase().includes(q.toLowerCase()) : true,
      );
  }, [data, status, q]);
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-border/60 bg-white p-3">
        ...
        <div className="relative min-w-[220px] flex-1">
          ...
          <Input
            ...
            placeholder="Search by ID or room type"
        ...
        {selected ? (
          <Link
            ...
            params={{ hotelId: String(selected) }}
