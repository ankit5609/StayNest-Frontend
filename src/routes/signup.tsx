...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Create your account — StayNest" },
      {
        name: "description",
        content:
          "Join StayNest to unlock exclusive stays, member rates and personalized recommendations.",
      },
      { property: "og:title", content: "Create your account — StayNest" },
      {
        property: "og:description",
        content: "Join StayNest and make every stay memorable.",
      },
    ],
  }),
  ...
  return (
    <main className="min-h-screen bg-background px-3 py-3 md:flex md:items-center md:justify-center md:px-6 md:py-6">
      <motion.div
        ...
        className="mx-auto grid w-full max-w-[1180px] overflow-hidden rounded-[28px] bg-background shadow-[0_30px_100px_-40px_rgba(17,26,19,0.35)] ring-1 ring-black/[0.04] md:h-[min(820px,calc(100vh-3rem))] md:grid-cols-[54%_46%]"
      >
        {/* LEFT — hero panel */}
        <section className="relative isolate overflow-hidden bg-surface min-h-[300px] md:min-h-full">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(253,250,246,0.55) 0%, rgba(253,250,246,0.15) 45%, rgba(17,26,19,0) 100%)",
            }}
          />
