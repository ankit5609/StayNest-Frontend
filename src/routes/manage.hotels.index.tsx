...
export const Route = createFileRoute("/manage/hotels/")({
...
function HotelsListPage() {
  ...
  const [toDelete, setToDelete] = useState<AdminHotelDto | null>(null);
  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-8">
      ...
      {!isLoading && !isError && hotels.length === 0 && (
        <div className="rounded-3xl border border-border/60 bg-white p-14 text-center">
...
function HotelCard({
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-border/60 bg-white shadow-[0_2px_10px_-6px_rgba(17,26,19,0.15)] transition-shadow hover:shadow-[0_10px_30px_-10px_rgba(17,26,19,0.25)]">
      <Link
      ...
      >
        <div className="relative aspect-[16/10] bg-surface">
          ...
          <span
            className={`absolute left-3 top-3 rounded-full px-2.5 py-1 text-[10.5px] font-medium uppercase tracking-[0.14em] ${
              hotel.active
