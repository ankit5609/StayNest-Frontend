...
export const Route = createFileRoute("/manage/hotels/$hotelId")({
  component: HotelWorkspacePage,
});

function HotelWorkspacePage() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-6">
      <div>
        <Link
          to="/manage/hotels"
          className="inline-flex items-center gap-1.5 text-[12.5px] text-muted-foreground hover:text-primary"
        >
...
function TabTrigger({
  ...
  return (
    <TabsTrigger
      value={value}
      className="flex items-center gap-2 rounded-xl px-4 py-2 text-[13px] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
    >
      {icon}
      {label}
    </TabsTrigger>
